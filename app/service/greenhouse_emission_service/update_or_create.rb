module GreenhouseEmissionService::UpdateOrCreate
  def self.call enterprise, greenhouse_emission_params
    ...
    greenhouse_emission_detail = greenhouse_emission
                                ...
                                ) if EmissionReason.find(greenhouse_emission_params[:emission_reason_id])
    greenhouse_emission_detail.update!(greenhouse_emission_params.except(:year_of_investigation))
    greenhouse_emission
  end
end